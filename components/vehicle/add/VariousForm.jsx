		...
		<div className={`slideAnimation`}>
			<div className={classes.formControl}>
				<TextField
					...
					error={titleHasError}
					type="text"
					helperText={titleHasError ? 'Merci de compléter cette information' : ''}
				/>
			</div>
			...
			<div className={classes.formControl}>
				<TextField
					...
					type="number"
					helperText={distanceHasError ? 'Merci de compléter cette information' : ''}
				/>
			</div>
			...
			<div className={classes.formControl}>
				<TextField
					...
					error={priceHasError}
					type="number"
					helperText={priceHasError ? 'Merci de compléter cette information' : ''}
				/>
			</div>
			...
			<div className={classes.formControl}>
				<TextField
					...
					helperText={localisationHasError ? 'Merci de compléter cette information' : ''}
				/>
			</div>
			<div className={classes.formControl}>
			...
			<div className={classes.formControl}>
				<TextField
					...
					type="text"
					multiline
					helperText={descriptionHasError ? 'Merci de compléter cette information' : ''}
				/>
			</div>
		</div>
	);
