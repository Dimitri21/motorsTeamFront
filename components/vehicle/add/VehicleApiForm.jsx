    ...
    <div className={`slideAnimation`}>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            brandHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            carModelHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            carTypeHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            motorHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            gearboxHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
        <TextField
          ...
          type="text"
          helperText={
            fuelTypeHasError ? "Merci de compléter cette information" : ""
          }
        />
      </div>
      <div className={classes.formControl}>
